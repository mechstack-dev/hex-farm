...
export const BUILDING_COSTS: Record<string, { wood: number; stone: number }> = {
  ...
  'auto-harvester': { wood: 50, stone: 30 },
};
...
export const ITEM_PRICES: Record<string, number> = {
  ...
  'blueberry': 15, 'raspberry': 15, 'tulip': 20, 'lavender': 20,
  ...
  'fish': 40, 'honey': 30, 'wildflower-honey': 30, 'sunflower-honey': 60,
  'apple-honey': 70, 'orange-honey': 70, 'peach-honey': 70, 'cherry-honey': 70,
  'tulip-honey': 80, 'lavender-honey': 80, 'coal': 15,
...
export const RECIPES: Record<string, Record<string, number>> = {
  ...
  'mushroom-risotto': { 'mushroom': 2, 'flour': 1 },
  'corn-bread': { 'cornmeal': 2, 'flour': 1 },
  ...
  'pumpkin-pie': { 'pumpkin': 1, 'flour': 1, 'egg': 1 },
  'apple-cider': { 'apple': 3, 'honey': 1 },
  'orange-juice': { 'orange': 3 },
  'peach-cobbler': { 'peach': 3, 'flour': 1 },
  'cherry-pie': { 'cherry': 3, 'flour': 1 },
  'fruit-medley': { 'apple': 1, 'orange': 1, 'peach': 1, 'cherry': 1 },
  'royal-breakfast': { 'golden-egg': 1, 'large-milk': 1, 'flour': 1 },
